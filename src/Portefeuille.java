public class Portefeuille {
  ...
  {
      if ( !(destination.getMonnaie().getNom().equals(this.getMonnaie().getNom()))) return false ;
      if ( this.montant - montantJetons < 0                                       ) return false ;
  ...
  public boolean achatDevise (double montantEuros)
  {
	...
	this.montant += this.getMonnaie().getValeurDeJeton() * montantEuros ;
	return true ;
  }
